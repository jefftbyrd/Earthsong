...
export default function SnapshotItem({
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="flex flex-row gap-0 justify-between w-full border-white/50 border-r-2 border-b-2 border-solid py-3 pr-3 drop-shadow-xl/20">
          ...
          <div className="flex flex-col gap-1 ml-0 my-1 pr-5 w-full  ">
            ...
            <button
              className="  text-md uppercase font-basteleur tracking-wider text-left text-white/90 bg-black/30 hover:bg-black/70 active:bg-white/50 active:text-black w-fit p-3"
              onClick={async () => {
                try {
          ...
          <div className="flex ml-auto">
            ...
            <button
              ...
              className="hover:text-white text-black/70 md:text-sm [writing-mode:vertical-rl] [text-orientation:upright] tracking-[0em] text-xs border-black/30  border-l-1 pl-1.5 h-auto w-auto"
            >
              remove
            </button>
